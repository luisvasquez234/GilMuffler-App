## Briefing 2026-07-25
Verifiqué 7 candidatos y descarté 4 por tener dominio propio. Estos 3 pasaron doble verificación:

## Los 3 negocios

- **Caceres Auto Repair** (53 Water St, Lawrence) — Sin página web de ningún tipo. Solo ficha de Yelp y una página de Facebook. Los horarios se contradicen entre directorios (unos dicen 9-6 los 7 días, otros 8-6 con domingo distinto) y sigue apareciendo listado con el nombre antiguo "Santos Auto Repair" en la misma dirección y teléfono, así que un cliente que busque no sabe ni cómo se llama ni cuándo abre — contacto: (978) 682-5128

- **Repostería Miguelina** (154 Essex St, Lawrence) — No tiene sitio oficial. Lo que sale en Google son páginas-plantilla de terceros (`hey-restaurants.com`, `res-menu.net`) que en su propio pie dicen *"This is not an official website. The content is updated by the community"*. El menú está incompleto y casi sin precios; el negocio no controla nada de esa información — contacto: (978) 975-3378

- **Chiquito's Tire Shop** (98 McFarlin Ct, Lawrence) — Sin web, solo un enlace de Facebook. Peor aún: circulan dos direcciones (98 McFarlin Ct y 85 Bay State Rd) y dos teléfonos ((978) 273-3417 y (978) 258-5329), más una ficha suelta en Methuen. Varios directorios lo tienen sin horarios y con el perfil "sin reclamar" — contacto: (978) 273-3417

## Cómo lo verifiqué

Yelp y Facebook devuelven 403 y no los pude leer directamente, así que para cada negocio usé dos comprobaciones independientes: (1) buscar si existe un dominio propio, y (2) abrir al menos dos directorios que muestran explícitamente el campo "website". Caceres salió "no website" en MerchantCircle y Yahoo Local; Chiquito's en Loc8NearMe y RepairHit; Miguelina no tiene dominio propio en ninguna búsqueda y sus páginas se autodeclaran no oficiales.

**Descartados para que no pierdas el tiempo:** El Pez Dorado (tiene `elpezdoradolawrence.com`), Lu's Cafe & Bakery (`luscafeandbakery.com`), Tenares (`tenarestire.com`, aunque el certificado está caducado) y Korbani's Bakery (sitio viejo alojado en Comcast, pero sí tiene horarios y dirección).

**Un detalle a tu favor:** Caceres y Chiquito's están los dos pegados a McFarlin Ct, a pocas calles entre sí. Con Gil's Muffler como prueba social, ese barrio es tu mejor terreno — puedes pasar a los dos el mismo día y enseñar en el teléfono lo que hiciste para un taller de la misma zona.

Sources:
- [Yelp — Caceres Automobile Repair](https://www.yelp.com/biz/caceres-automobile-repair-lawrence)
- [MerchantCircle — Caceres Auto Repair](https://www.merchantcircle.com/caceres-auto-repair1-lawrence-ma)
- [Yahoo Local — Caceres Automobile Repair](https://local.yahoo.com/info-10097724-caceres-automobile-repair-lawrence/)
- [Repostería Miguelina (página de terceros)](https://reposteria-miguelina.hey-restaurants.com/)
- [Yelp — Repostería Miguelina](https://www.yelp.com/biz/reposteria-miguelina-lawrence)
- [Loc8NearMe — Chiquito's Tire Shop](https://www.loc8nearme.com/massachusetts/lawrence/chiquitos-tire-shop/4399558/)
